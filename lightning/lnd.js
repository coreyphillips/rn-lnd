...
class LND {
	...
	async _initWallet() {
		try {
			...
			try {
				console.log("Logging sendUnlockerCommand response");
				console.log(response);
			} catch {}
			const cipherSeedMnemonic = response.cipherSeedMnemonic;
			console.log("Attempting to log cipherSeedMnemonic...");
			console.log(cipherSeedMnemonic);
